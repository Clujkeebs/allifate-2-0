...
export function CreatePage() {
  ...
  async function handleGenerate() {
    ...
    // Simulate pipeline stages while the edge function runs
    const stages = PIPELINE_STAGES.map((s, i) => ({ stage: i, delay: i * 3000 }))
    ...
    try {
      ...
      setTimeout(() => navigate(`/review/${job.id}`), 1200)
    }
  }
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 28 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: '#8B9EB0', fontSize: 14 }}>Describe what you want — SocialMind handles the rest.</p>
      </div>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        {showAdvanced && (
          <div className="animate-slide-up" style={{ background: '#0F1318', border: '1px solid #1E2A36', borderRadius: 12, padding: 20, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div>
